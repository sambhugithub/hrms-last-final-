...
class AuthorizingOfficerPage extends StatefulWidget {
  final List<AuthorizingOfficer> data;
  const AuthorizingOfficerPage({
    required this.data,
    super.key});

  @override
  State<AuthorizingOfficerPage> createState() => _AuthorizingOfficerPageState();
}

class _AuthorizingOfficerPageState extends State<AuthorizingOfficerPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Authorizing Officers', style: TextStyle(fontSize: 20.sp),),
      ),
      body: Container(
        height: MediaQuery
            .of(context)
          ...
          child: SingleChildScrollView(
            ...
            child: DataTable(
              ...
              headingRowColor: MaterialStateColor.resolveWith((states) {
                return appcolor1.withOpacity(.8);
              },),
              ...
              columns: [
                ...
                DataColumn(label: Text(
                    'Do you have a Criminal Conviction/Bankruptcy')),
