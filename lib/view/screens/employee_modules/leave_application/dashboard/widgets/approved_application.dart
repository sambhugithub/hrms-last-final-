...
class ApprovedApplication extends StatefulWidget {
  const ApprovedApplication({super.key});

  @override
  State<ApprovedApplication> createState() => _ApprovedApplicationState();
}

class _ApprovedApplicationState extends State<ApprovedApplication> {

  apiCall()async{
    WidgetsBinding.instance.addPostFrameCallback((_)async {
      await context.read<LeaveApplicationProvider>().setLeaveStatusType('APPROVED');
  ...
  Widget build(BuildContext context) {
    return Consumer<LeaveApplicationProvider>(
      builder: (_,instance,child){
        ...
        :instance.employeeLeaveStatusData!.data!.length==0?
            Center(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          SizedBox(
                            width: 300.w,
                            child: Text('${DateTime.parse(instance.employeeLeaveStatusData!.data![index].updatedAt!)}',style: TextStyle(fontWeight: FontWeight.w400,fontSize: 20.sp,),),
                          )
                        ],
                      ),
